...
"hombros": `<strong>Nombres alternativos:</strong> Deltoides, "Deltos".<br><br><strong>Descripción y Partes:</strong> Músculo que envuelve la articulación del hombro, dando forma redondeada.<br>• <strong>Deltoides Anterior:</strong> Parte frontal (empujes).<br>• <strong>Deltoides Lateral (Medial):</strong> Parte lateral (anchura).<br>• <strong>Deltoides Posterior:</strong> Parte trasera (tracción).`,
                ...
                "aductores": `<strong>Nombres alternativos:</strong> Aductores.<br><br><strong>Descripción y Partes:</strong> Músculos situados en la parte interna del muslo, encargados de cerrar las piernas.`,

                "abductores": `<strong>Nombres alternativos:</strong> Abductores.<br><br><strong>Descripción y Partes:</strong> Músculos situados en la parte externa de la cadera/muslo (incluyendo el tensor de la fascia lata), encargados de abrir las piernas.`,
    }
};
